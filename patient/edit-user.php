    ...
    if($_POST){
        ...
        if ($password==$cpassword){
            ...
            if($id2!=$id){
                $error='1';
                //$resultqq1= $database->query("select * from doctor where spemail='$email';");
                ...
                $sql1="update patient set pemail='$email',pname='$name',ppassword='$password',prut='$rut',ptel='$tele',paddress='$address' where pid=$id ;";
                $database->query($sql1);
                echo $sql1;
